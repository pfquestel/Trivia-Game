...
const questions = [
  ...
  { mode: "world_trivia", question: "Which country has a town named 'Y'?", answers: ["France", "Germany", "Norway", "Canada"] },
  { mode: "world_trivia", question: "What is illegal to own as a pet in Queensland, Australia?", answers: ["Rabbit", "Parrot", "Turtle", "Snake"] },
  { mode: "world_trivia", question: "Which country has more sheep than people?", answers: ["New Zealand", "Iceland", "Scotland", "Argentina"] },
  { mode: "world_trivia", question: "In which country is it illegal to own only one guinea pig?", answers: ["Switzerland", "Finland", "Denmark", "Japan"] },
  { mode: "world_trivia", question: "Where is the world’s largest pyramid located?", answers: ["Mexico", "Egypt", "China", "Peru"] },
  { mode: "world_trivia", question: "Which country has the longest national anthem?", answers: ["Greece", "Canada", "Brazil", "Russia"] },
  { mode: "world_trivia", question: "What country is home to the world’s largest swimming pool?", answers: ["Chile", "USA", "Australia", "Spain"] },
  { mode: "world_trivia", question: "Which country banned chewing gum?", answers: ["Singapore", "Japan", "South Korea", "United Arab Emirates"] },
  { mode: "world_trivia", question: "Which country has the most islands in the world?", answers: ["Sweden", "Indonesia", "Philippines", "Canada"] },
  { mode: "world_trivia", question: "Which country has the most time zones?", answers: ["France", "USA", "Russia", "China"] },
  { mode: "world_trivia", question: "Which European country has a unicorn as its national animal?", answers: ["Scotland", "Ireland", "Wales", "Belgium"] },
  { mode: "world_trivia", question: "Which country is home to the world's smallest known reptile?", answers: ["Madagascar", "Brazil", "Indonesia", "India"] },
  { mode: "world_trivia", question: "What is the only country where you can find the Komodo dragon in the wild?", answers: ["Indonesia", "Thailand", "Malaysia", "Vietnam"] },
  { mode: "world_trivia", question: "Which country is famous for its cheese-rolling festival?", answers: ["United Kingdom", "Switzerland", "France", "Netherlands"] },
  { mode: "world_trivia", question: "What country has a city named Batman?", answers: ["Turkey", "USA", "Brazil", "South Korea"] },
  { mode: "world_trivia", question: "Which country celebrates New Year’s Eve first?", answers: ["Kiribati", "New Zealand", "Australia", "Japan"] },
  { mode: "world_trivia", question: "Which country has a lake that turns animals into stone?", answers: ["Tanzania", "Bolivia", "Ethiopia", "Kazakhstan"] },
  { mode: "world_trivia", question: "Which country is home to the world's largest desert that isn't made of sand?", answers: ["Antarctica", "Canada", "Russia", "Greenland"] },
  { mode: "world_trivia", question: "In which country was the first ever traffic light installed?", answers: ["United Kingdom", "United States", "Germany", "France"] },
  { mode: "world_trivia", question: "What is the only country in the world without an official capital?", answers: ["Nauru", "Vatican City", "San Marino", "Liechtenstein"] },
  { mode: "world_trivia", question: "Which country holds the record for the longest place name in the world?", answers: ["New Zealand", "Wales", "Thailand", "Finland"] },
  { mode: "world_trivia", question: "Which country has a hotel made entirely of ice that must be rebuilt every year?", answers: ["Sweden", "Canada", "Russia", "Norway"] },
  { mode: "world_trivia", question: "Which country has the most volcanoes?", answers: ["Indonesia", "Japan", "United States", "Philippines"] },
  { mode: "world_trivia", question: "Which country has a bridge reserved exclusively for squirrels?", answers: ["Netherlands", "Sweden", "Denmark", "Belgium"] },
  { mode: "world_trivia", question: "Which country has glow-in-the-dark beaches due to bioluminescent plankton?", answers: ["Maldives", "Australia", "Thailand", "Hawaii"] },
  { mode: "world_trivia", question: "Which country is home to a giant statue of a potato?", answers: ["United States", "New Zealand", "Canada", "Ireland"] },
  { mode: "world_trivia", question: "Which country has a law stating you must smile at all times in public?", answers: ["Milan, Italy", "Tokyo, Japan", "Oslo, Norway", "Stockholm, Sweden"] },
  { mode: "world_trivia", question: "Which country has a real-life pink lake?", answers: ["Australia", "Canada", "Argentina", "India"] },
  { mode: "world_trivia", question: "Which country has a post office in the middle of the ocean?", answers: ["Vanuatu", "Maldives", "Fiji", "Bahamas"] },
  { mode: "world_trivia", question: "Which country has a festival where people throw tomatoes at each other?", answers: ["Spain", "Italy", "Mexico", "Argentina"] }
];
